...
function flavorChose(flavor) {
  return `El sabor que elegistes fue ${flavor}`;
}
...
function LaHeladeria() {
  let flavor = prompt(
    'Ingrese el sabor qu quieres (fresa, melon, sandia, naranja, kiwi)'
  ).toLocaleLowerCase();
...
/*
Funcion que grabarq nombres con una longitud entre 7 a 9 caracteres
*/
